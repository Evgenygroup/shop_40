package de.ait_tr.supplier.scheduler;
...
//    @Scheduled(cron = "0 0 23 * * *") // Отправка заявки поставщику ежедневно в 23 ч.
    ...
    public void sendSupplyRequest() {
        ...
        // 1. Получаем товарные остатки по всем продуктам из магазина (первый бэкенд).
        ...
        //    вычисляем, сколько продуктов нужно заказать поставщику. Формируем заказ.
