...
public class TokenService {
    ...
    // три метода ниже для проверки подлинности
   ...
   // следующие три метода для извлечения информации о пользователе из токена
    ...
    public AuthInfo mapClaimsToAuthInfo(Claims claims) {  // для передачи информации в обьект AuthInfo, который (этот обьект) понимает SpringSecurity
